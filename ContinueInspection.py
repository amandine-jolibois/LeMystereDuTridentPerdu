...
def draw_ContinueInspection(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_ContinueInspection():
    pygame.display.set_caption("Continuer L'Inspection")
    ...
    while running:
        ...
        draw_ContinueInspection(choix1, choix2, text_box, display_buttons)

if __name__ == "__main__":
    main_ContinueInspection()