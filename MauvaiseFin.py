...
def draw_MauvaiseFin(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_MauvaiseFin():
    pygame.display.set_caption("C'est la FIN mais pas la bonne !")
    ...
    while running:
        ...
        draw_MauvaiseFin(choix1, choix2, text_box, display_buttons)
