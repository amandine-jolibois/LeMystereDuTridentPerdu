...
def draw_SortTemple(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_SortTemple():
    pygame.display.set_caption("Sortir Du Temple")
    ...
    while running:
        ...
        draw_SortTemple(choix1, choix2, text_box, display_buttons)
