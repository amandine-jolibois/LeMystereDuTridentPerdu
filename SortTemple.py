...
from SeCacheDesMechants2 import main_SeCacheDesMechants2
...
def draw_SortTemple(choix1, text_box, next_button):
    global i
...
def main_SortTemple():
    ...
    #show_buttons = False
    pygame.display.set_caption("SortTemple")
    # pygame.display.set_icon(icon)

    choix1 = Button(screen_width // 3, 220, screen_width // 3, 50, "Se cacher des méchants", open_new_window_choix1)

    # Créer une instance de TextBox et définir le texte
    text_box = TextBox(0, 400, screen_width, 200)
    text_box.set_text(" \n - En arrivant à l’entrée du temple, vous entendez des voix humaines plus loin")
    ...
    draw_SortTemple(choix1, text_box, next_button)
            ...
            if event.type == pygame.QUIT:
                ...
                if choix1.rect.collidepoint(event.pos):
                    ...
                    if next_button.action:
                        ...
                        if i == 0:
                            son_BruitEcho.play()
                            text_box.set_new_text("\n“ECOUTEZ bande de guignolos !”\n \n“Fouillez le temple, détruisez-le si il le faut”\n \n“Et éliminez la vermine qui tentera de s’opposer à nous.”")
                            draw_SortTemple(choix1, text_box, next_button)
                        elif i == 1:
                            text_box.set_new_text("\n“A VOS ORDRES CHEF !”")
                            draw_SortTemple(choix1, text_box, next_button)
                            ...
                            son_BruitForet.play()
                            text_box.set_new_text("\n“Il faut que je me cache et vite !”")
                            draw_SortTemple(choix1, text_box, next_button)
