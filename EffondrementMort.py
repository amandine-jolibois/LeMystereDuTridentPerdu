...
def draw_EffondrementMort(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_EffondrementMort():
    pygame.display.set_caption("La MORT")
    ...
    while running:
        ...
        draw_EffondrementMort(choix1, choix2, text_box, display_buttons)

if __name__ == "__main__":
    main_EffondrementMort()