...
def draw_FinPartie2(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_FinPartie2():
    pygame.display.set_caption("Fin Deuxième Partie")
    ...
    while running:
        ...
        draw_FinPartie2(choix1, choix2, text_box, display_buttons)
