...
def draw_PasserParPlage(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_PasserParPlage():
    pygame.display.set_caption("La PLAGE")
    ...
    while running:
        ...
        draw_PasserParPlage(choix1, choix2, text_box, display_buttons)
