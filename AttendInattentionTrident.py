...
def draw_AttendInattentionTrident(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_AttendInattentionTrident():
    pygame.display.set_caption("Attends Le Moment D'Inattention Pour Prendre Le Trident")
    ...
    while running:
        ...
        draw_AttendInattentionTrident(choix1, choix2, text_box, display_buttons)
