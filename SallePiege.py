...
def draw_SallePiege(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_SallePiege():
    pygame.display.set_caption("Salle Piege")
    ...
    while running:
        ...
        draw_SallePiege(choix1, choix2, text_box, display_buttons)
