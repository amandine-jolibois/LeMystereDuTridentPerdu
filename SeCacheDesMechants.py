...
def draw_SeCacheDesMechants(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_SeCacheDesMechants():
    pygame.display.set_caption("Se Cache Des Mechants")
    ...
    while running:
        ...
        draw_SeCacheDesMechants(choix1, choix2, text_box, display_buttons)
