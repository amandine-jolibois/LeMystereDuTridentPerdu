...
right_images = [image.load("personages\\mechantoff.png"), image.load("personages\\mechant.png"), image.load("personages\\mechant.png"), image.load("personages\\mechantoff.png")]
...
def draw_SeCacheDesMechants(choix1, text_box, next_button):
    global i
...
def main_SeCacheDesMechants():
    global i
    pygame.mixer.music.load("Son\\Environnement\\Embiance.mp3")
    pygame.mixer.music.play(-1)
    pygame.mixer.music.set_volume(0.1)
    #show_buttons = False
    pygame.display.set_caption("SeCacheDesMechants")
    # pygame.display.set_icon(icon)

    choix1 = Button(screen_width // 3, 220, screen_width // 3, 50, "S'enfuir", open_new_window_choix1)
    ...
    draw_SeCacheDesMechants(choix1, text_box, next_button)
