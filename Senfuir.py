...
from MauvaiseFin import main_MauvaiseFin
...
# Chargez les images
left_images = [image.load("personages\\hero.png"), image.load("personages\\hero.png"), image.load("personages\\herooff.png"), image.load("personages\\hero.png")]
...
def draw_Senfuir(choix1, text_box, next_button):
    global i
...
def main_Senfuir():
    ...
    #show_buttons = False
    pygame.display.set_caption("Senfuir")
    ...
    text_box = TextBox(0, 400, screen_width, 200)
    text_box.set_text(" \n“Dommage pour le trident mais c'est trop dangereux de les suivre.”")
    ...
    draw_Senfuir(choix1, text_box, next_button)
            ...
            if event.type == pygame.QUIT:
                ...
                if choix1.rect.collidepoint(event.pos):
                    ...
                    if next_button.action:
                        next_button.action()
                        if i == 0:
                            text_box.set_new_text("\n“Malgré tout ces efforts je n'ai pas le choix”")
                            draw_Senfuir(choix1, text_box, next_button)
                        elif i == 1:
                            text_box.set_new_text("\n- Vous devez désormais trouver un moyen de partir de cet endroit.")
                            draw_Senfuir(choix1, text_box, next_button)
                        elif i == 2:
                            text_box.set_new_text("\n-“Je dois fuir de cette île !”")
                            draw_Senfuir(choix1, text_box, next_button)
