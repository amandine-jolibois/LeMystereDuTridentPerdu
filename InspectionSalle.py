...
def draw_InspectionSalle(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_InspectionSalle():
    pygame.display.set_caption("Inspection De La Salle")
    ...
    while running:
        ...
        draw_InspectionSalle(choix1, choix2, text_box, display_buttons)

if __name__ == "__main__":
    main_InspectionSalle()