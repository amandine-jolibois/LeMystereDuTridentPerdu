...
def draw_PrendTrident(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_PrendTrident():
    pygame.display.set_caption("Prend Trident")
    ...
    while running:
        ...
        draw_PrendTrident(choix1, choix2, text_box, display_buttons)
