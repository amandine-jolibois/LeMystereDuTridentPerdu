...
from SortTemple import main_SortTemple
...
def draw_PrendTrident(choix1, text_box, next_button):
    global i
...
def main_PrendTrident():
    ...
    draw_PrendTrident(choix1, text_box, next_button)
                ...
                if choix1.rect.collidepoint(event.pos):
                    ...
                    if next_button.action:
                        ...
                        if i == 0:
                            ...
                            son_BruitEcho.play()
                            text_box.set_new_text("\n“Enfin devant la sortie du temple nom de Dieu.”")
                            draw_PrendTrident(choix1, text_box, next_button)
