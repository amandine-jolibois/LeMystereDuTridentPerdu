...
def draw_FinPartie1(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_FinPartie1():
    pygame.display.set_caption("Fin Premiere Partie")
    ...
    while running:
        ...
        draw_FinPartie1(choix1, choix2, text_box, display_buttons)
