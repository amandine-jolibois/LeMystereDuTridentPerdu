...
def draw_TrouSurLeCoter(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_TrouSurLeCoter():
    pygame.display.set_caption("Trou Sur Le Coter")
    ...
    while running:
        ...
        draw_TrouSurLeCoter(choix1, choix2, text_box, display_buttons)
