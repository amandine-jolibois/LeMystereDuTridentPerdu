...
def draw_ActionnaireTrouver(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_ActionnaireTrouver():
    pygame.display.set_caption("Actionnaire Trouver")
    ...
    while running:
        ...
        draw_ActionnaireTrouver(choix1, choix2, text_box, display_buttons)

if __name__ == "__main__":
    main_ActionnaireTrouver()