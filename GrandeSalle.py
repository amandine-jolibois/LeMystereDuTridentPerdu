...
def draw_GrandeSalle(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_GrandeSalle():
    pygame.display.set_caption("La Grande Salle")
    ...
    while running:
        ...
        draw_GrandeSalle(choix1, choix2, text_box, display_buttons)
