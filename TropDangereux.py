...
def draw_TropDangereux(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_TropDangereux():
    pygame.display.set_caption("Trop Dangereux")
    ...
    while running:
        ...
        draw_TropDangereux(choix1, choix2, text_box, display_buttons)
