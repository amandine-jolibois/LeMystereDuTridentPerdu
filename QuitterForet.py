...
def draw_QuitterForet(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_QuitterForet():
    pygame.display.set_caption("Quitter Foret")
    ...
    while running:
        ...
        draw_QuitterForet(choix1, choix2, text_box, display_buttons)
