...
def draw_CarteTrident(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_CarteTrident():
    pygame.display.set_caption("La Carte Du Trident")
    ...
    while running:
        ...
        draw_CarteTrident(choix1, choix2, text_box, display_buttons)
