...
def draw_OuverturePorte(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_OuverturePorte():
    pygame.display.set_caption("Porte Ouverte")
    ...
    while running:
        ...
        draw_OuverturePorte(choix1, choix2, text_box, display_buttons)
