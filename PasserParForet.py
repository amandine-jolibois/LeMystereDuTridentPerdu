...
def draw_PasserParForet(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_PasserParForet():
    pygame.display.set_caption("Passer Par La Fôret")
    ...
    while running:
        ...
        draw_PasserParForet(choix1, choix2, text_box, display_buttons)
