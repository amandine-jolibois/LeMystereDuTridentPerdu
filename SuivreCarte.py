...
def draw_SuivreCarte(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_SuivreCarte():
    pygame.display.set_caption("Suivre La Carte")
    ...
    while running:
        ...
        draw_SuivreCarte(choix1, choix2, text_box, display_buttons)
