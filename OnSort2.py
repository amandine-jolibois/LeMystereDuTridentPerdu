...
from SeCacheDesMechants import main_SeCacheDesMechants
...
def draw_OnSort2(choix1, text_box, next_button):
    global i
...
def main_OnSort2():
    ...
    #show_buttons = False
    pygame.display.set_caption("OnSort2")
    ...
    text_box = TextBox(0, 400, screen_width, 200)
    text_box.set_text(" \n- En sortant, vous remarquez un groupe de mercenaires.")
    ...
    draw_OnSort2(choix1, text_box, next_button)
