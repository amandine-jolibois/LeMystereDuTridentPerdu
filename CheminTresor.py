...
def draw_CheminTresor(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_CheminTresor():
    pygame.display.set_caption("Troisième Chemin")
    ...
    while running:
        ...
        draw_CheminTresor(choix1, choix2, text_box, display_buttons)
