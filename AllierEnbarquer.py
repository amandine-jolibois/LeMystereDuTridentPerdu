...
def draw_AllierEnbarquer(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_AllierEnbarquer():
    pygame.display.set_caption("Allier Embarquer")
    ...
    while running:
        ...
        draw_AllierEnbarquer(choix1, choix2, text_box, display_buttons)
