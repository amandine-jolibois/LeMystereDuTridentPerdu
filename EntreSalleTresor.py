...
def draw_EntreSalleTresor(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_EntreSalleTresor():
    pygame.display.set_caption("La Salle Du Tresor")
    ...
    while running:
        ...
        draw_EntreSalleTresor(choix1, choix2, text_box, display_buttons)

if __name__ == "__main__":
    main_EntreSalleTresor()