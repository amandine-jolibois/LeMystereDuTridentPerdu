...
import sys
import time
from Chemin1 import main_Chemin1
from CheminTresor import main_CheminTresor
from Chemin2 import main_Chemin2
...
def draw_GrandeSalle(choix1, choix2, choix3, text_box, display_buttons):
    screen.blit(background_image, (0, 0))
...
def main_GrandeSalle():
    pygame.display.set_caption("Grande Salle")
    choix1 = Button(screen_width // 4, 120, screen_width // 2, 50, "Chemin de gauche", open_new_window_choix1)
    choix2 = Button(screen_width // 4, 200, screen_width // 2, 50, "Chemin du millieu", open_new_window_choix2)
    choix3 = Button(screen_width // 4, 280, screen_width // 2, 50, "Chemin de droite", open_new_window_choix3)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if choix1.rect.collidepoint(event.pos):
                    ...
                    if choix2.action:
                        choix2.action()
                elif choix3.rect.collidepoint(event.pos):
                    # Action pour le bouton "choix3"
                    if choix3.action:
                        choix3.action()
                running = False

        draw_GrandeSalle(choix1, choix2, choix3,  text_box, display_buttons)
