...
def draw_ResterAvec(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_ResterAvec():
    pygame.display.set_caption("Reste Avec MOI")
    ...
    while running:
        ...
        draw_ResterAvec(choix1, choix2, text_box, display_buttons)
