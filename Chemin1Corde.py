...
def draw_Chemin1Corde(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_Chemin1Corde():
    pygame.display.set_caption("Premier Chemin")
    ...
    while running:
        ...
        draw_Chemin1Corde(choix1, choix2, text_box, display_buttons)
