...
def draw_RetourArriere(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_RetourArriere():
    pygame.display.set_caption("Indécis non ?")
    ...
    while running:
        ...
        draw_RetourArriere(choix1, choix2, text_box, display_buttons)
