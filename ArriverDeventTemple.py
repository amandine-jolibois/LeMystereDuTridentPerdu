...
def draw_ArriverDevantTemple(choix1, choix2, text_box, display_buttons):
    screen.fill(BLACK)
...
def main_ArriverDevantTemple():
    pygame.display.set_caption("Arrivé Devant Le Temple")
    ...
    while running:
        ...
        draw_ArriverDevantTemple(choix1, choix2, text_box, display_buttons)
